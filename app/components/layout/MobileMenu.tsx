        ...
        <nav className="flex flex-col px-5 py-6">
          ...
          <div className="mt-8 flex flex-col gap-3">
            <a
              ...
              className="flex min-h-11 items-center justify-center accent-fill px-6 text-base font-semibold text-on-accent"
            >
              Call {company.phone}
            </a>
            <a
              ...
              className="flex min-h-11 items-center justify-center border border-steel-400 px-6 text-base font-semibold text-ink"
            >
              WhatsApp
            </a>
          </div>
