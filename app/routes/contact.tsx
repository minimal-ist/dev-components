              ...
              <div className="border border-steel-300 bg-sheet-raised p-7">
                ...
                <div className="mt-6 flex flex-col gap-3">
                  <a
                    ...
                    className="flex min-h-12 items-center gap-3 accent-fill px-5 text-sm font-semibold text-on-accent transition-[filter] hover:brightness-95"
                  >
                  ...
                  <a
                    ...
                    className="flex min-h-12 items-center gap-3 border border-steel-400 px-5 text-sm font-semibold text-ink transition-colors hover:border-ink"
                  >
